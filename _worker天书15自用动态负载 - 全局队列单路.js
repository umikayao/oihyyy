...
let 哎呀呀这是我的VL密钥 = "88aae542-bd31-43a1-b7cd-7735910bc6d4"; //建议更改为自己的标准化UUID

let 启用反代功能 = true //选择是否启用反代功能【总开关】，false，true，现在你可以自由的选择是否启用反代功能了
let 反代IP = 'tw.umika.cc.cd:443' //反代IP或域名，反代IP端口一般情况下不用填写，如果你非要用非标反代的话，可以填'ts.hpc.tw:443'这样
...
let 转发地址 = ['tutu.samui.kdns.fr','gritu.umika.cc.cd','tutu.222551.xyz','tutu.kirali.cc.cd','tutu.meouo.eu.cc','tutu.222656.xyz',
  //'www.111.com', //示例
];
//////////////////////////////////////////////////////////////////////////DOH配置/////////////////////////////////////////////////////////////////////////
